...
class TestRuleService:
    ...
    async def test_get_global_rulesets_success(self, mock_openremote_client, sample_ruleset):
        ...
        with patch('src.services.mcp_server.app.services.rule.get_openremote_service') as mock_get_service:
            mock_service = MagicMock()
            mock_service.client = mock_openremote_client
            mock_get_service.return_value = mock_service
            
            from src.services.mcp_server.app.services.rule import get_global_rulesets
            
            result = await get_global_rulesets()
    ...
    async def test_get_global_ruleset_success(self, mock_openremote_client, sample_ruleset):
        ...
        with patch('src.services.mcp_server.app.services.rule.get_openremote_service') as mock_get_service:
            ...
            from src.services.mcp_server.app.services.rule import get_global_ruleset
            
            result = await get_global_ruleset(1)
    ...
    async def test_create_global_ruleset_success(self, mock_openremote_client):
        ...
        with patch('src.services.mcp_server.app.services.rule.get_openremote_service') as mock_get_service:
            ...
            from src.services.mcp_server.app.services.rule import create_global_ruleset
            
            ruleset_schema = GlobalRulesetSchema(name="New Rule", rules="test")
            result = await create_global_ruleset(ruleset_schema)
    ...
    async def test_update_global_ruleset_success(self, mock_openremote_client, sample_ruleset):
        ...
        with patch('src.services.mcp_server.app.services.rule.get_openremote_service') as mock_get_service:
            ...
            from src.services.mcp_server.app.services.rule import update_global_ruleset
            
            ruleset_schema = GlobalRulesetSchema(name="Updated Rule", rules="test")
            result = await update_global_ruleset(1, ruleset_schema)
    ...
    async def test_delete_global_ruleset_success(self, mock_openremote_client):
        ...
        with patch('src.services.mcp_server.app.services.rule.get_openremote_service') as mock_get_service:
            ...
            from src.services.mcp_server.app.services.rule import delete_global_ruleset
            
            result = await delete_global_ruleset(1)
    ...
    async def test_get_realm_rulesets_success(self, mock_openremote_client, sample_ruleset):
        ...
        with patch('src.services.mcp_server.app.services.rule.get_openremote_service') as mock_get_service:
            ...
            from src.services.mcp_server.app.services.rule import get_realm_rulesets
            
            result = await get_realm_rulesets("master")
    ...
    async def test_get_asset_rulesets_success(self, mock_openremote_client, sample_ruleset):
        ...
        with patch('src.services.mcp_server.app.services.rule.get_openremote_service') as mock_get_service:
            ...
            from src.services.mcp_server.app.services.rule import get_asset_rulesets
            
            result = await get_asset_rulesets("asset-123")
    ...
    async def test_get_global_engine_info_success(self, mock_openremote_client):
        ...
        with patch('src.services.mcp_server.app.services.rule.get_openremote_service') as mock_get_service:
            ...
            from src.services.mcp_server.app.services.rule import get_global_engine_info
            
            result = await get_global_engine_info()
    ...
    async def test_get_asset_geofences_success(self, mock_openremote_client):
        ...
        with patch('src.services.mcp_server.app.services.rule.get_openremote_service') as mock_get_service:
            ...
            from src.services.mcp_server.app.services.rule import get_asset_geofences
            
            result = await get_asset_geofences("asset-123")
